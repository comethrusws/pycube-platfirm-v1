...
export const transfusionData = {
  ...
  // Hospital Network
  hospitals: [
    { id: 1, name: 'Main Hospital - Central Campus', bags: 520, alerts: 5, tempAlerts: 3, location: 'Central', beds: 850 },
    { id: 2, name: 'Main Hospital - North Tower', bags: 480, alerts: 4, tempAlerts: 2, location: 'North', beds: 720 },
    { id: 3, name: 'Main Hospital - South Wing', bags: 445, alerts: 3, tempAlerts: 2, location: 'South', beds: 680 },
    { id: 4, name: 'Emergency Trauma Center', bags: 410, alerts: 6, tempAlerts: 4, location: 'Trauma', beds: 420 },
    { id: 5, name: 'Surgical Pavilion', bags: 385, alerts: 4, tempAlerts: 2, location: 'Surgical', beds: 380 },
    { id: 6, name: 'Cancer Treatment Center', bags: 340, alerts: 3, tempAlerts: 1, location: 'Oncology', beds: 320 },
    { id: 7, name: 'Cardiac Care Center', bags: 315, alerts: 2, tempAlerts: 1, location: 'Cardiac', beds: 280 },
    { id: 8, name: 'Women\'s Hospital', bags: 290, alerts: 3, tempAlerts: 2, location: 'Women', beds: 250 },
    { id: 9, name: 'Children\'s Hospital', bags: 265, alerts: 2, tempAlerts: 1, location: 'Pediatric', beds: 220 },
    { id: 10, name: 'Transplant Institute', bags: 240, alerts: 4, tempAlerts: 2, location: 'Transplant', beds: 180 },
    { id: 11, name: 'Community Hospital - East', bags: 195, alerts: 2, tempAlerts: 1, location: 'East', beds: 150 },
    { id: 12, name: 'Community Hospital - West', bags: 180, alerts: 3, tempAlerts: 2, location: 'West', beds: 140 },
    { id: 13, name: 'Outpatient Surgery Center', bags: 165, alerts: 1, tempAlerts: 0, location: 'Outpatient', beds: 80 },
    { id: 14, name: 'Rehabilitation Hospital', bags: 145, alerts: 2, tempAlerts: 1, location: 'Rehab', beds: 120 },
    { id: 15, name: 'Behavioral Health Center', bags: 125, alerts: 1, tempAlerts: 0, location: 'Behavioral', beds: 100 },
    { id: 16, name: 'Long-Term Care Facility', bags: 110, alerts: 1, tempAlerts: 0, location: 'LTC', beds: 90 },
    { id: 17, name: 'Regional Medical Center', bags: 95, alerts: 1, tempAlerts: 0, location: 'Regional', beds: 75 },
    { id: 18, name: 'Urgent Care Network', bags: 75, alerts: 1, tempAlerts: 0, location: 'Urgent', beds: 45 },
  ] as BloodInventory[],
